...
log_pct_46003=log(CalPreds$pct_46003)
outlier.preds.ref.raw=data.frame(logSQ_KM,ElevCat_standardized,logPrecip8110Ws,Tmean8110Ws_standardized,log_pct_46003, row.names=CalPreds$SiteID)
...
log_pct_46003=log(prednew$pct_46003)

outlier.preds.test.raw=data.frame(logSQ_KM,ElevCat_standardized,logPrecip8110Ws,Tmean8110Ws_standardized, log_pct_46003,row.names=prednew$sampleId)
...
modelappinputactive=modelappinput[,c(1:5)]
